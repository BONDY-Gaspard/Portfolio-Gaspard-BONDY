...
<template>
    <div class="flex flex-col items-center mb-12 md:mb-0 md:flex-row md:justify-center md:space-x-[200px] md:mt-40">
    ...
    <div class="space-y-6 mb-12 md:space-y-8 md:mb-0 lg:space-y-10">
        <div class="flex items-center space-x-12 ml-5 md:space-x-14 lg:space-x-16 group transition-transform duration-300 ease-in-out transform hover:scale-110">
            <p class="text-red-700 text-[13px] font-normal font-rubik md:text-[15px] lg:text-[17px]">2023</p>
            <div>
                <p class="text-base font-bold font-rubik md:text-lg lg:text-xl">Ticketing reception agent (CDD)</p>
                <p class="text-[9px] font-normal font-rubik md:text-[11px] lg:text-[13px]">Saline Royale d’Arc-et-Senans (UNESCO)</p>
            </div>
        </div>
        <div class="flex items-center space-x-12 ml-5 md:space-x-14 lg:space-x-16 group transition-transform duration-300 ease-in-out transform hover:scale-110">
            <p class="text-red-700 text-[13px] font-normal font-rubik md:text-[15px] lg:text-[17px]">2022</p>
            <div>
                <p class="text-base font-bold font-rubik md:text-lg lg:text-xl">Diver (CDD)</p>
                <p class="text-[9px] font-normal font-rubik md:text-[11px] lg:text-[13px]">Restaurant l’Arbé, La Clusaz</p>
            </div>
        </div>
        <div class="flex items-center space-x-12 ml-5 md:space-x-14 lg:space-x-16 group transition-transform duration-300 ease-in-out transform hover:scale-110">
            <p class="text-red-700 text-[13px] font-normal font-rubik md:text-[15px] lg:text-[17px]">2021</p>
            <div>
                <p class="text-base font-bold font-rubik md:text-lg lg:text-xl">Multi-skilled employee (CDD)</p>
                <p class="text-[9px] font-normal font-rubik md:text-[11px] lg:text-[13px]">Camping les Promenades, Quingey</p>
            </div>
        </div>
        <div class="flex items-center space-x-12 ml-5 md:space-x-14 lg:space-x-16 group transition-transform duration-300 ease-in-out transform hover:scale-110">
            <p class="text-red-700 text-[13px] font-normal font-rubik md:text-[15px] lg:text-[17px]">2019</p>
            <div>
                <p class="text-base font-bold font-rubik md:text-lg lg:text-xl">Baker's helper (STAGE)</p>
                <p class="text-[9px] font-normal font-rubik md:text-[11px] lg:text-[13px]">Maison Deschamps, Besançon</p>
            </div>
        </div>
    </div>
</div>
