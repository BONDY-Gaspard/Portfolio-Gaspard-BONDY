...
const images = ref([
  { src: '/soireecanap.webp', title: 'Soirée Canap', description: 'Student Talk Show', projectName: 'soiree-canap' },
    ...
    <div>
      <div class="carousel">
        ...
        <div class="mx-12 mt-5 md:mx-0 md:ml-[821px]">
            ...
            <router-link :to="{ name: 'projectpage', params: { projectId: currentImage.projectName, projectName: currentImage.projectName } }" class="text-blue-500 hover:underline">Learn more</router-link>
        </div>
      </div>
